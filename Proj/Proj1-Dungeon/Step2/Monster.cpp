...
//    room = _room;
//    serial = _serial;
//    std::cout << "ID set for the monster, room is " + std::to_string(_room) + "serial is: " + std::to_string(_serial) << std::endl;
//}
//
//void Monster::setName(std::string _name) {
//    name = _name;
//    std::cout << "set name for the monster, name is: \"" + _name + "\""<< std::endl;
//}
//
